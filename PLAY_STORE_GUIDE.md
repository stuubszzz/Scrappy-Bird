...
3. Under **Facebook Login > Settings**, in "Valid OAuth Redirect URIs" paste:
   `https://jftpuanpidvsddkqqypw.supabase.co/auth/v1/callback`
4. Under **App settings > Basic**, copy the **App ID** and **App Secret**.
5. Open https://supabase.com/dashboard/project/jftpuanpidvsddkqqypw, go to **Authentication > Providers > Facebook**, turn it on, paste the App ID and App Secret, save.
